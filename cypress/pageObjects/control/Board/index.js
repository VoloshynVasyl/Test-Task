...
class Board {
  ...
  constructor(paramsObj) {
    ...
    this.container = () => this.parentContainerLocator()
      .find(this.containerLocator);

    this._appliedColumn = new Column({
      parentContainer: this.container,
      containerLocator: this.appliedColumnLocator,
    });
    this._interviewingColumn = new Column({
      parentContainer: this.container,
      containerLocator: this.interviewingColumnLocator,
    });
    this._hiredColumn = new Column({
      parentContainer: this.container,
      containerLocator: this.hiredColumnLocator,
    });
  }
