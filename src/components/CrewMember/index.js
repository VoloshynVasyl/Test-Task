    ...
    return (
      <div className="CrewMember-container">
        ...
        <div className="CrewMember-toolbar">
          {onDown && <button onClick={onDown} type="button" data-aut-id="down-button">&lt;</button>}
          {onUp && <button onClick={onUp} className="CrewMember-up" type="button" data-aut-id="up-button">&gt;</button>}
        </div>
      </div>
    );
  }
