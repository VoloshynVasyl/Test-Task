    ...
    return (
      <div className="App">
        ...
        <div className="App-container">
          <div className="App-column" data-aut-id="applied-column">
            <CrewContainer name="Applied" hiringStage="applied" />
          </div>
          <div className="App-column" data-aut-id="interviewing-column">
            <CrewContainer name="Interviewing" hiringStage="interviewing" />
          </div>
          <div className="App-column" data-aut-id="hired-column">
