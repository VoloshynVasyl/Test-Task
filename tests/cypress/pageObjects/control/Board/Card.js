class Card {
    ...
    constructor(paramsObj) {
        ...
        this.container = () => this.parentContainer().find(this.containerLocator)
    }

    get info() {
        return this.container().find(this.infoLocator);
    }
    ...
    get toolbar() {
        return this.container().find(this.toolbarLocator);
    }
